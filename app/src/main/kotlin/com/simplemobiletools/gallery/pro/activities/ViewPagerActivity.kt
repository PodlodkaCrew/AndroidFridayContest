...
import kotlinx.android.synthetic.main.activity_medium.bottom_actions
import kotlinx.android.synthetic.main.activity_medium.top_shadow
import kotlinx.android.synthetic.main.activity_medium.view_pager
...
import kotlinx.android.synthetic.main.bottom_actions.bottom_resize
...
class ViewPagerActivity : SimpleActivity(), ViewPager.OnPageChangeListener, ViewPagerFragment.FragmentListener {
    ...
    private fun refreshViewPager() {
        if (config.getFolderSorting(mDirectory) and SORT_BY_RANDOM == 0) {
            GetMediaAsynctask(this, mDirectory, false, false, mShowAll) {
                gotMedia(it)
            }.execute()
        }
    }
